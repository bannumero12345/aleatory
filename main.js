...
global.premium = [`${setting.ownerNumber}@s.whatsapp.net`] // Premium user has unlimited limit
  ...
  try {
    ...
    m.exp += 1
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (plugin.premium && !isPremium) { // Premium
          fail('premium', m, this)
          continue
        }
        ...
        if (!isPremium && global.DATABASE._data.users[m.sender].limit < m.limit * 1 && plugin.limit) {
